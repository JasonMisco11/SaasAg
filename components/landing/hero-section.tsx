  ...
  return (
    <section id="hero" className="relative mx-auto mt-32 max-w-[80rem] px-6 text-center md:px-8 ">
      <div className="backdrop-filter-[12px] transition-all ease-in hover:cursor-pointer group gap-1 translate-y-[-1rem] animate-fade-in opacity-0">
        <ShinyButton className="inline-flex items-center justify-center flex-nowrap rounded-full">
          <span>✨ Join the best design studios & startups</span>{" "}
          <ArrowRightIcon className="ml-1 size-3 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
        </ShinyButton>
      </div>
      <h1 className="bg-gradient-to-br dark:from-white from-black from-30% dark:to-white/40 to-black/40 bg-clip-text pt-12 pb-8 text-5xl font-medium leading-none tracking-tighter text-transparent text-balance sm:text-6xl md:text-7xl lg:text-8xl translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
